...
async function saveEdit(slug) {
  ...
  try {
    const res = await fetch(`${CFG.BACKEND_URL}/api/save-law`, {
      method: 'POST',
...
async function renderTickets() {
  ...
  try {
    const res = await fetch(`${CFG.BACKEND_URL}/api/tickets-list`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function createTicket() {
  try {
    const res = await fetch(`${CFG.BACKEND_URL}/api/tickets-create`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ accessToken: CURRENT_USER.accessToken }),
    });
...
async function closeTicket(channelId) {
  ...
  try {
    const res = await fetch(`${CFG.BACKEND_URL}/api/tickets-close`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function loginWithToken(accessToken, silent = false) {
  try {
    ...
    const roleRes = await fetch(`${CFG.BACKEND_URL}/api/check-role`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
